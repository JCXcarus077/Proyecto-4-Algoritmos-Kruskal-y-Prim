...
class Grafo:
    ...
    # def addArista(self, u, v, peso):
        # arista = (u, v)
        # self.aristas.append(arista)
        # self.pesos[arista] = peso
        # if not self.dirigido:
        #     arista_reversa = (v, u)
        #     self.aristas.append(arista_reversa)
        #     self.pesos[arista_reversa] = peso
        # print("Aristas (después de agregar):", self.aristas)  # Debug: Verificar las aristas
...
if __name__ == "__main__":
    ...
    #g = grafoMalla(10,10)
    #g = grafoErdosRenyi(15,15) 
    #g = grafoGilbert(100, 0.15) #0.15,0.04
    #g = grafoGeografico(300, 0.09) #0.09
    #g = grafoBarabasiAlbert(3,300)#30,300
    #g = grafoDorogovtsevMendes(100)#30, 100

    # mst_kruskalD, total_distance_kruskalD = g.kruskalD()
    # mst_kruskalI, total_distance_kruskalI = g.kruskalI()
    # mst_prim, total_distance_prim = g.prim()
    
    # Mostrar valor del MST
    # print("MST KruskalD:", "{:.2f}".format(total_distance_kruskalD))
    # print("MST KruskalI:", "{:.2f}".format(total_distance_kruskalI))
    # print("MST Prim:", "{:.2f}".format(total_distance_prim))
